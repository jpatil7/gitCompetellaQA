...
public class R3TenantManagerPage {
    private static final Logger LOGGER = Logger.getLogger(R3TenantManagerPage.class);
    private WebDriver driver;

    public R3TenantManagerPage(WebDriver driver) {
        this.driver = driver;
    }
