...
public class R3ContactCenterPage {
    private static final Logger LOGGER = Logger.getLogger(R3ContactCenterPage.class);
    private WebDriver driver;

    public R3ContactCenterPage(WebDriver driver) {
        this.driver = driver;
    }
